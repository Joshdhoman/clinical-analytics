...
export const metadata: Metadata = {
  ...
  description:
    "Eleven finished data visualizations: regression, event studies, a calendar heatmap, and labor-market charts, each with a note on how the figure was produced.",
